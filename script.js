...
const translations = {
  en: {
    ...
    achievementsTitle: "Selected achievements and public appearances.",
    achievementsDeck: "Academic appointments, invited talks, teaching projects, community activities, interviews, and institutional profiles.",
    ...
    heroLede:
      "I have lived and worked in Japan since 2009. At Ritsumeikan Asia Pacific University, I teach courses, lead faculty workshops, and work on intercultural and multilingual learning.",
    ...
    visualPublic: "A recorded conversation about games and Japan",
    visualJapan: "Everyday life in Japan",
    apuBandEyebrow: "My academic home now",
    apuBandTitle: "Intercultural education and faculty development at APU.",
    apuBandBody: "Based in Beppu, I work on intercultural education, faculty development, and public communication at APU.",
    videoEyebrow: "Watch & Listen",
    videoTitle: "Selected videos and recorded conversations.",
    videoDeck: "Course introductions, interviews, and public conversations about education, Japan, games, and intercultural communication.",
    ...
    artifactTitle: "Original posters and programme materials.",
    artifactDeck: "Materials from APU, Hokkaido University, the University of Tokyo, and Ritsumeikan programmes.",
    ...
    galleryDeck: "Photographs from classes, workshops, and facilitated sessions.",
    ...
    startHereNavLabel: "Three routes through the portfolio",
    startHereTitle: "Choose the part of my work that is closest to what you are looking for.",
    startHereDeck: "Choose teaching and faculty development, research, or public writing. Each route leads to the relevant projects and materials.",
    startHereTeachingAudience: "For educators and institutions",
    startHereTeachingTitle: "Teaching and faculty development",
    startHereTeachingBody: "Courses, workshops, materials, and practical tools for multilingual and intercultural learning.",
    startHereTeachingLink: "Enter the teaching portfolio →",
    startHereResearchAudience: "For researchers and collaborators",
    startHereResearchTitle: "Research",
    startHereResearchBody: "Publications and projects on intercultural learning, language technology, and higher education.",
    startHereResearchLink: "Follow the research →",
    startHereWritingAudience: "For readers, media, and cultural projects",
    startHereWritingTitle: "Japan, games, and public writing",
    startHereWritingBody: "Long-form reporting and cultural interpretation shaped by nearly three decades of writing as Mazzi.",
    startHereWritingLink: "Browse the writing →",
    trajectoryEyebrow: "Background",
    trajectoryTitle: "Education and work in Krakow, Hokkaido, and Beppu.",
    trajectoryBodyOne:
      "I studied language and literature in Krakow, came to Japan on a MEXT scholarship, and completed a PhD in information science at Hokkaido University, specialising in natural language processing.",
    trajectoryBodyTwo:
      "For nearly three decades I have written as Mazzi for Polish readers. My university work has included language-learning systems, natural language processing, intercultural classrooms, and faculty development.",
    timelineEyebrow: "A few coordinates",
    timelineTitle: "Selected stages of my academic and professional work.",
    ...
    timelineTwoTitle: "Doctoral research in information science",
    ...
    timelineThreeTitle: "Faculty-development workshops",
    ...
    timelineFiveBody: "At APU, I teach and work on intercultural learning, faculty development, and public communication.",
    ...
    caseStudiesTitle: "Four selected teaching and facilitation projects.",
    caseStudiesDeck:
    ...
    teachingTitle: "Selected teaching and facilitation practice.",
    ...
    proofTitle: "Four selected teaching and faculty-development projects.",
    ...
    bridgeEyebrow: "Academic and public work",
    bridgeTitle:
      "University teaching and nearly three decades of writing about games.",
    bridgeBodyOne:
      "As Mazzi, I have reported from Japan, interviewed game creators, covered Tokyo Game Show, and written long-form articles for Polish readers.",
    bridgeBodyTwo:
      "At university, I teach and conduct work in intercultural communication, global learning, faculty development, and multilingual higher education.",
    writingPageLink: "Browse the writing portfolio",
    bridgeQuote: "Two longstanding parts of my work: higher education and public writing about Japan, games, and media.",
    editorialEvidenceNagoshi: "Interview · Toshihiro Nagoshi",
    editorialEvidenceValkyrie: "Interview visit · Valkyrie Profile creators",
    identityAcademicTerm: "Academic work",
    identityAcademicDesc: "Assistant Professor, higher education researcher, faculty developer.",
    identityPublicTerm: "Writing",
    identityPublicDesc: "Japan-based writer on games, media, popular culture, and everyday interpretation.",
    identityAxisTerm: "Selected topics",
    identityAxisDesc: "Communication, learning, culture, and meaning across borders.",
    essayEyebrow: "Position Essay",
    essayTitle: "Worlds without instruction manuals.",
    essayBody:
    ...
    writingPageTitle: "Writing on Japan, games, and media culture.",
    writingPageDeck:
      "Selected original PSX Extreme manuscripts: event reports, interviews, Japanese game history, technology and market analysis, reviews, and feature articles.",
    ...
    writingCtaTitle: "Writing, interviews, and public conversations.",
    writingCtaBody:
      "Contact me about interviews, guest lectures, cultural commentary, editorial collaborations, or public-facing academic projects.",
    writingCtaLink: "Discuss a writing project",
    mapEyebrow: "Profile Map",
    mapTitle: "Main areas of work.",
    mapOneTitle: "Academic home",
    mapOneBody:
      "APU, intercultural communication, global learning, EMI, curriculum design, and faculty development.",
    mapTwoTitle: "Public voice",
    mapTwoBody:
      "Writing as Mazzi for PSX Extreme about Japan, games, and media culture.",
    mapThreeTitle: "Research and teaching",
    mapThreeBody:
      "Research on intercultural learning, language, classroom participation, and faculty development.",
    mapFourTitle: "Talks and collaboration",
    mapFourBody:
      "Invited talks, workshops, essays, and collaborative projects.",
    ...
    downloadBrief: "Download the two-page workshop brief",
    contactProfilesEyebrow: "Useful addresses",
    contactProfilesTitle: "Formal profiles, research records, and public work.",
    contactInstagramEyebrow: "From Japan, Mostly",
    contactInstagramTitle: "The smaller things that do not need a CV heading.",
    contactInstagramBody: "Posts about Japan, games, travel, books, and everyday observations.",
    contactInstagram: "Follow @mazzipl",
    contactInstitution: "APU faculty profile",
    contactInstitutionDetail: "Institutional record and current faculty information.",
    contactResearch: "Researchmap",
    contactResearchDetail: "Publications, projects, and research activity.",
    contactProfessional: "LinkedIn",
    contactProfessionalDetail: "Professional profile and current network.",
    contactPublic: "Torii interview",
    contactPublicDetail: "A long-form conversation about living and working in Japan.",
    serviceEyebrow: "Teaching Portfolio",
    serviceTitle: "Courses, workshops, and seminars built around real learning problems",
    serviceDeck:
      "I teach credit-bearing courses, lead practical workshops, and give seminars for university communities. Topics include intercultural communication, EMI, course design, assessment, active learning, and responsible use of AI.",
    ...
    workshopHeroBrief: "Read the two-page brief",
    ...
    teachingMaterialsTitle: "Four examples from workshop and course materials.",
    teachingMaterialsDeck:
      "Selected pages from original presentations used in sessions on presentation skills, activity design, feedback, and intercultural communication.",
    ...
    essayPageTitle: "Worlds without instruction manuals",
    essayPageDeck:
      "An essay about games as cultural systems, everyday life in Japan, public writing, and intercultural education.",
    backTop: "Back to top",
    ...
    interactiveLabTitle: "Try three interactive activities from the portfolio.",
  ...
  pl: {
    ...
    achievementsTitle: "Wybrane osiągnięcia i wystąpienia publiczne.",
    achievementsDeck: "Stanowiska akademickie, zaproszone wykłady, projekty dydaktyczne, działania społeczne, wywiady i profile instytucjonalne.",
    ...
    researchPageDeck:
      "Moje badania wyrastają z sytuacji, których doświadczyłem w praktyce: wielojęzycznych klas, systemów wspierających naukę języków, spotkań w turystyce i interdyscyplinarnego programu kosmicznego. Pytam, co pomaga ludziom odczytywać różnice, współpracować i uczyć się z większym poczuciem sprawczości.",
    ...
    researchMapCore: "Co pomaga ludziom uczestniczyć mimo różnic?",
    researchMapContextLabel: "Kontekst",
    researchMapEvidenceLabel: "Dowód / metoda",
    researchMapOneTitle: "Wielojęzyczne klasy",
    researchMapOneBody: "Różnice, pewność siebie i poczucie przynależności widziane przez pryzmat zadań realizowanych na zajęciach i refleksji.",
    ...
    researchMapTwoTitle: "Systemy wspierające naukę języków",
    researchMapTwoBody: "Nauka słownictwa angielskiego i japońskiego badana z wykorzystaniem NLP, projektowania systemów i ewaluacji użytkowników.",
    researchMapTwoEvidenceTitle: "Projektowanie systemu NLP",
    researchMapTwoEvidenceBody: "Przełączanie kodów językowych, teksty dostosowane do poziomu i ewaluacja użytkowników w publikacjach z lat 2016–2018.",
    ...
    researchMapThreeEvidenceBody: "Pięć punktów kontaktu opartych na działaniach, zbadanych w Kaszanie w Iranie.",
    ...
    researchMapCaption: "Razem projekty łączą dowody z sali zajęciowej, projektowanie systemów, badania terenowe i wdrażanie programów.",
    heroKicker: "Adiunkt w Japonii · Edukator międzykulturowy · Autor piszący jako Mazzi",
    heroLede:
      "Mieszkam i pracuję w Japonii od 2009 roku. Na Ritsumeikan Asia Pacific University prowadzę zajęcia i warsztaty dla kadry oraz pracuję nad uczeniem międzykulturowym i wielojęzycznym.",
    ...
    visualTeaching: "Nauczanie i facylitacja międzykulturowa",
    visualPublic: "Nagranie rozmowy o grach i Japonii",
    visualJapan: "Codzienne życie w Japonii",
    apuBandEyebrow: "Mój obecny dom akademicki",
    apuBandTitle: "Edukacja międzykulturowa i rozwój dydaktyczny kadry na APU.",
    apuBandBody: "Mieszkam w Beppu i pracuję na APU nad edukacją międzykulturową, rozwojem dydaktycznym kadry i komunikacją publiczną.",
    videoEyebrow: "Zobacz i posłuchaj",
    videoTitle: "Wybrane nagrania i rozmowy.",
    videoDeck: "Prezentacje kursów, wywiady oraz rozmowy o edukacji, Japonii, grach i komunikacji międzykulturowej.",
    ...
    artifactTitle: "Oryginalne plakaty i materiały programowe.",
    artifactDeck: "Materiały z APU, Hokkaido University, University of Tokyo i programów Ritsumeikan.",
    ...
    galleryDeck: "Fotografie z zajęć, warsztatów i facylitowanych spotkań.",
    ...
    startHereEyebrow: "Zacznij tutaj",
    startHereNavLabel: "Trzy ścieżki przez portfolio",
    startHereTitle: "Wybierz część mojej pracy najbliższą temu, czego szukasz.",
    startHereDeck: "Wybierz dydaktykę i rozwój kadry, badania albo publicystykę. Każda ścieżka prowadzi do odpowiednich projektów i materiałów.",
    startHereTeachingAudience: "Dla edukatorów i instytucji",
    startHereTeachingTitle: "Dydaktyka i rozwój kadry",
    startHereTeachingBody: "Kursy, warsztaty, materiały i praktyczne narzędzia wspierające wielojęzyczne oraz międzykulturowe uczenie się.",
    startHereTeachingLink: "Wejdź do portfolio dydaktycznego →",
    startHereResearchAudience: "Dla badaczy i współpracowników",
    startHereResearchTitle: "Badania",
    startHereResearchBody: "Publikacje i projekty dotyczące uczenia międzykulturowego, technologii językowych i szkolnictwa wyższego.",
    startHereResearchLink: "Poznaj badania →",
    startHereWritingAudience: "Dla czytelników, mediów i projektów kulturalnych",
    startHereWritingTitle: "Japonia, gry i publicystyka",
    startHereWritingBody: "Reportaże i interpretacja kultury oparte na blisko trzech dekadach pisania jako Mazzi.",
    startHereWritingLink: "Przejdź do tekstów →",
    trajectoryEyebrow: "Doświadczenie",
    trajectoryTitle: "Edukacja i praca w Krakowie, na Hokkaido i w Beppu.",
    trajectoryBodyOne:
      "Studiowałem język i literaturę w Krakowie, przyjechałem do Japonii jako stypendysta MEXT, a na Hokkaido University obroniłem doktorat z informatyki, specjalizując się w przetwarzaniu języka naturalnego.",
    trajectoryBodyTwo:
      "Od blisko trzech dekad piszę jako Mazzi dla polskich czytelników. Moja praca uniwersytecka obejmowała systemy wspierające naukę języków, przetwarzanie języka naturalnego, zajęcia międzykulturowe i rozwój dydaktyczny kadry.",
    timelineEyebrow: "Kilka współrzędnych",
    timelineTitle: "Wybrane etapy mojej pracy akademickiej i zawodowej.",
    timelineOneTitle: "Początek życia w Japonii",
    timelineOneBody: "Przyjeżdżam na stypendium MEXT i zaczynam poznawać codzienność życia pomiędzy językami.",
    timelineOneLink: "Zobacz dorobek ↗",
    timelineTwoTitle: "Badania doktoranckie w informatyce",
    timelineTwoBody: "Doktorat z informatyki na Hokkaido University prowadzi do badań nad Co-MIX — systemem wspierającym naukę języków, w którym najważniejsze są kontekst, wybór i doświadczenie osób uczących się.",
    timelineTwoLink: "Poznaj badania Co-MIX ↗",
    timelineThreeTitle: "Warsztaty rozwoju dydaktycznego kadry",
    timelineThreeBody: "Zaproszone warsztaty o nauczaniu po angielsku i komunikacji międzykulturowej przenoszą pytania badawcze do praktyki dydaktycznej.",
    ...
    timelineFiveTitle: "APU, Beppu",
    timelineFiveBody: "Na APU zajmuję się dydaktyką, uczeniem międzykulturowym, rozwojem kadry i komunikacją publiczną.",
    ...
    bioBodyTwo:
      "Moja droga akademicka łączy język i literaturę, japonistykę, informatykę oraz przetwarzanie języka naturalnego. Przed rozpoczęciem pracy na APU pracowałem i prowadziłem zajęcia na Hokkaido University, rozwijając kursy oraz działania wspierające dydaktykę kadry: nauczanie po angielsku, komunikację międzykulturową, projektowanie programów i krytyczne wykorzystanie generatywnej AI w szkolnictwie wyższym.",
    bioBodyThree:
      "Równolegle z pracą uniwersytecką piszę jako Mazzi o Japonii, grach wideo, kulturze mediów i codziennym życiu. W tej publicystyce ujmuję interpretacje kulturowe i złożone konteksty w przystępny sposób, łącząc zainteresowania akademickie z dziennikarstwem, grami i współczesną kulturą Japonii.",
    academicEyebrow: "Co robię",
    academicTitle: "Pomagam ludziom uczyć się mimo różnic kulturowych, medialnych i instytucjonalnych.",
    featureOneTitle: "Projektuję proces uczenia się",
    featureOneBody:
      "Projektuję zajęcia, zadania i warsztaty dla kadry, które przekładają idee na użyteczną praktykę dydaktyczną.",
    featureTwoTitle: "Tłumaczę kulturę",
    featureTwoBody:
      "Moje badania i nauczanie dotyczą komunikacji międzykulturowej, tworzenia znaczeń oraz uczenia się mimo różnic językowych i instytucjonalnych.",
    ...
    caseTitle: "Jak ta praca wygląda, kiedy trafia do rzeczywistej sali zajęciowej.",
    ...
    caseThreeBody:
      "Na kursie Video Games in Society studenci pisali recenzje przeznaczone do publikacji i prezentowali koncepcje gier. Wybrane prace trafiły do PSX Extreme, a kurs otrzymał średnią ocenę 4,58/5.",
    ...
    caseStudiesTitle: "Cztery wybrane projekty dydaktyczne i facylitacyjne.",
    caseStudiesDeck:
    ...
    teachingTitle: "Wybrane przykłady dydaktyki i facylitacji.",
    ...
    workshopTitle: "Warsztaty dla kadry, doktorantów i zespołów dydaktycznych, które można dopasować do potrzeb instytucji.",
    ...
    workshopOutputFour: "Krótkie podsumowania końcowe, które pomagają ulepszać projekt",
    workshopPageLink: "Zobacz formaty warsztatów",
    proofEyebrow: "Udokumentowane doświadczenie",
    proofTitle: "Cztery wybrane projekty dydaktyczne i rozwojowe.",
    proofOneLabel: "2023 · Hokkaido University",
    proofOneTitle: "Rozwój dydaktyczny kadry wokół czterech praktycznych problemów",
    proofOneBody:
      "Sesje dotyczyły nauczania po angielsku, komunikacji międzykulturowej, projektowania sylabusa i przygotowania do korzystania z ChatGPT na zajęciach.",
    proofTwoLabel: "Wyróżnienie 2024 · Ewaluacja kursu 2023",
    proofTwoTitle: "Wyróżnienie Excellent Teacher za Video Games in Society",
    proofTwoBody:
      "Kurs otrzymał średnią ocenę 4,58/5 w ankiecie studenckiej wykorzystanej w procesie przyznawania wyróżnienia Excellent Teacher na Hokkaido University w 2023 roku.",
    proofThreeLabel: "2022 · AGH University of Science and Technology",
    ...
    portfolioFourBody:
      "Wsparcie dla edukatorów, którzy chcą przełożyć pytania dydaktyczne na pracę opartą na danych, lepszą informację zwrotną i projekty uczenia się, którymi można się dzielić.",
    ...
    samplerTwoBody:
      "Wykorzystuję osobiste doświadczenia, uporządkowany dialog i zadania refleksyjne, aby pomagać osobom uczącym się zauważać założenia, odczytywać kontekst i komunikować się mimo różnic.",
    samplerThreeLabel: "Pedagogika mediów",
    samplerThreeTitle: "Gry jako systemy kulturowe i społeczne",
    samplerThreeBody:
      "Projektuję proces uczenia się oparty na grach jako przestrzeniach, w których ludzie ćwiczą język, pracują z tożsamością, rozwijają myślenie projektowe, interpretują i publicznie analizują kulturę.",
    ...
    bridgeEyebrow: "Praca akademicka i publicystyczna",
    bridgeTitle:
      "Praca uniwersytecka i blisko trzy dekady pisania o grach.",
    bridgeBodyOne:
      "Jako Mazzi relacjonowałem wydarzenia z Japonii, przeprowadzałem wywiady z twórcami gier, opisywałem Tokyo Game Show i pisałem dłuższe teksty dla polskich czytelników.",
    bridgeBodyTwo:
      "Na uniwersytecie zajmuję się komunikacją międzykulturową, edukacją globalną, rozwojem dydaktycznym kadry i wielojęzycznym szkolnictwem wyższym.",
    writingPageLink: "Zobacz portfolio pisarskie",
    bridgeQuote: "Dwie długoletnie części mojej pracy: szkolnictwo wyższe oraz publicystyka o Japonii, grach i mediach.",
    editorialEvidenceNagoshi: "Wywiad · Toshihiro Nagoshi",
    editorialEvidenceValkyrie: "Wywiad · twórcy Valkyrie Profile",
    identityAcademicTerm: "Praca akademicka",
    identityAcademicDesc: "Adiunkt, badacz szkolnictwa wyższego, projektant rozwoju dydaktycznego kadry.",
    identityPublicTerm: "Pisanie",
    identityPublicDesc: "Autor piszący z Japonii o grach, mediach, popkulturze i codziennej interpretacji kultury.",
    identityAxisTerm: "Wybrane tematy",
    identityAxisDesc: "Komunikacja, uczenie się, kultura i tworzenie znaczeń mimo różnic.",
    essayEyebrow: "Esej programowy",
    essayTitle: "Światy bez instrukcji obsługi.",
    essayBody:
      "Esej o grach jako systemach kulturowych, codziennym życiu w Japonii, publicystyce i edukacji międzykulturowej.",
    essayLink: "Przeczytaj esej",
    writingPageEyebrow: "Portfolio pisarskie",
    writingPageTitle: "Teksty o Japonii, grach i kulturze mediów.",
    writingPageDeck:
      "Wybrane oryginalne teksty dla PSX Extreme: relacje z wydarzeń, wywiady, historia japońskich gier, analiza technologii i rynku, recenzje oraz artykuły przekrojowe.",
    ...
    writingCtaTitle: "Teksty, wywiady i rozmowy publiczne.",
    writingCtaBody:
      "Zapraszam do kontaktu w sprawie wywiadów, wykładów gościnnych, komentarzy kulturowych, współpracy redakcyjnej i projektów akademickich dla szerszej publiczności.",
    writingCtaLink: "Porozmawiajmy o projekcie pisarskim",
    mapEyebrow: "Mapa profilu",
    mapTitle: "Główne obszary pracy.",
    mapOneTitle: "Dom akademicki",
    mapOneBody:
      "APU, komunikacja międzykulturowa, edukacja globalna, EMI, projektowanie programów i rozwój dydaktyczny kadry.",
    mapTwoTitle: "Głos publiczny",
    mapTwoBody:
      "Teksty o Japonii, grach i kulturze mediów publikowane jako Mazzi w PSX Extreme.",
    mapThreeTitle: "Badania i dydaktyka",
    mapThreeBody:
      "Badania nad uczeniem międzykulturowym, językiem, uczestnictwem w zajęciach i rozwojem dydaktycznym kadry.",
    mapFourTitle: "Wystąpienia i współpraca",
    mapFourBody:
      "Zaproszone wystąpienia, warsztaty, eseje i projekty realizowane wspólnie z partnerami.",
    archiveEyebrow: "Dorobek i publikacje",
    archiveTitle: "Profile instytucjonalne i działalność publiczna dla osób, które chcą zobaczyć dowody.",
    ...
    contactBody:
      "Szczególnie interesuje mnie współpraca z centrami dydaktyki akademickiej, programami międzynarodowymi, szkołami doktorskimi oraz zespołami rozwijającymi wielojęzyczne i międzykulturowe środowiska uczenia się.",
    contactSignature: "W sprawach dydaktyki, badań, pracy redakcyjnej i rozmów publicznych możesz napisać po angielsku, polsku lub japońsku.",
    ...
    downloadBrief: "Pobierz opis warsztatów",
    contactProfilesEyebrow: "Przydatne adresy",
    contactProfilesTitle: "Profile formalne, dorobek badawczy i praca publiczna.",
    contactInstagramEyebrow: "From Japan, Mostly",
    contactInstagramTitle: "Mniejsze rzeczy, które nie potrzebują osobnego miejsca w CV.",
    contactInstagramBody: "Wpisy o Japonii, grach, podróżach, książkach i codziennych obserwacjach.",
    contactInstagram: "Obserwuj @mazzipl",
    contactInstitution: "Profil pracownika APU",
    contactInstitutionDetail: "Rekord instytucjonalny i aktualne informacje o pracy na uczelni.",
    contactResearch: "Researchmap",
    contactResearchDetail: "Publikacje, projekty i aktywność badawcza.",
    contactProfessional: "LinkedIn",
    contactProfessionalDetail: "Profil zawodowy i bieżąca sieć kontaktów.",
    contactPublic: "Wywiad dla Torii",
    contactPublicDetail: "Długa rozmowa o życiu i pracy w Japonii.",
    serviceEyebrow: "Portfolio dydaktyczne",
    serviceTitle: "Kursy, warsztaty i seminaria opracowane z myślą o rzeczywistych problemach uczenia się",
    serviceDeck:
      "Prowadzę kursy akademickie, praktyczne warsztaty i seminaria dla społeczności uniwersyteckich. Tematy obejmują komunikację międzykulturową, EMI, projektowanie kursów, ocenianie, aktywne uczenie się i odpowiedzialne korzystanie z AI.",
    ...
    workshopHeroBrief: "Przeczytaj krótki opis",
    workshopStartEmail: "Zapytaj o warsztat",
    ...
    teachingMaterialsTitle: "Cztery przykłady materiałów z kursów i warsztatów.",
    teachingMaterialsDeck:
      "Wybrane strony z oryginalnych prezentacji wykorzystywanych podczas sesji o wystąpieniach, projektowaniu aktywności, informacji zwrotnej i komunikacji międzykulturowej.",
    ...
    teachingMaterialTwoBody:
      "Cel, zadanie, czas, sposób pracy i rezultat pozwalają uczestnikom sprawdzić, czy aktywność będzie jasna i wykonalna.",
    ...
    teachingMaterialFourTitle: "Jak zdecydować, kiedy można bezpiecznie użyć AI",
    teachingMaterialFourBody:
    ...
    essayPageTitle: "Światy bez instrukcji obsługi",
    essayPageDeck:
      "Esej o grach jako systemach kulturowych, codziennym życiu w Japonii, publicystyce i edukacji międzykulturowej.",
    backTop: "Do góry",
    designStudioEyebrow: "Wypróbuj metodę",
    designStudioTitle: "Zamień problem dydaktyczny w niewielkie zadanie, które uczestnicy naprawdę mogą wykonać.",
    designStudioDeck: "To skrócona wersja modelu, z którego korzystam podczas projektowania zajęć i warsztatów Pre-FD. Wybierz rzeczywisty problem z sali, a następnie zaprojektuj możliwe rozwiązanie, określając cel, zadanie, czas, sposób pracy i widoczny rezultat.",
    designStudioChallengeTitle: "Wybierz problem",
    ...
    designStudioResearchBody: "Pięć pytań pomaga jasno połączyć zamierzony efekt uczenia się, zadanie i widoczny dowód. Ta logika czerpie z konstruktywnego dopasowania i badań nad aktywnym uczeniem się; studio jest praktycznym narzędziem wspierającym projektowanie, a nie automatycznym planem zajęć.",
    ...
    designStudioOutputEyebrow: "Szkic aktywności",
    designStudioOutputNote: "Krótka próba, informacja zwrotna od innych albo bilet wyjścia pozwalają przekształcić pomysł w materiał, który można dalej doskonalić.",
    designStudioCopy: "Skopiuj konspekt aktywności",
    designStudioRemix: "Zaskocz mnie",
    interactiveLabEyebrow: "Interaktywne portfolio",
    interactiveLabTitle: "Wypróbuj trzy interaktywne aktywności z portfolio.",
    interactiveLabDeck: "Trzy krótkie doświadczenia, do których można wracać, zamieniają naukę języka, projektowanie zajęć i reportaż w decyzje podejmowane samodzielnie.",
    interactiveLabComixMeta: "Nauka języka · 4–6 min",
    interactiveLabComixTitle: "Laboratorium słownictwa Co-MIX",
    interactiveLabComixBody: "Przejdź od rozpoznania wielojęzycznej wskazówki do przywołania z pamięci i ponownego użycia nowego słowa.",
    interactiveLabPlay: "Rozpocznij ćwiczenie →",
    interactiveLabStudioMeta: "Projektowanie zajęć · 3–5 min",
    interactiveLabStudioTitle: "Studio projektowania zajęć",
    interactiveLabStudioBody: "Zamień rzeczywisty problem z sali zajęciowej w niewielką aktywność, którą da się przeprowadzić.",
    interactiveLabBuild: "Zbuduj aktywność →",
    interactiveLabGameMeta: "Opowieść z wyborami · 5–8 min",
    interactiveLabGameTitle: "Tokyo Game Show: Press Pass",
    interactiveLabGameBody: "Wybierz trasę reportażową, zarządzaj energią, zbieraj szczegóły i stwórz możliwy lead.",
    interactiveLabEnter: "Rozpocznij grę paragrafową →",
  },
};
...
translations.ja = {
  ...
  achievementsTitle: "主な実績とパブリックな活動。",
  achievementsDeck: "大学での職歴、招待講演、教育プロジェクト、地域活動、インタビュー、所属機関による紹介を掲載しています。",
  ...
  videoEyebrow: "見る・聞く",
  videoTitle: "主な動画と収録インタビュー。",
  videoDeck: "教育、日本、ゲーム、異文化コミュニケーションに関する授業紹介、インタビュー、公開対話です。",
  ...
  artifactTitle: "オリジナルのポスターとプログラム資料。",
  artifactDeck: "APU、北海道大学、東京大学、立命館のプログラムで使用した資料です。",
  ...
  galleryDeck: "授業、ワークショップ、ファシリテーションの記録写真です。",
  ...
  caseStudiesTitle: "教育・ファシリテーションの四つの事例。",
  ...
  writingPageTitle: "日本、ゲーム、メディア文化についての執筆。",
  writingPageDeck: "PSX Extremeのために書いたオリジナル記事から、イベント取材、インタビュー、日本のゲーム史、テクノロジーと市場の分析、レビュー、特集記事を紹介します。",
  ...
  writingCtaTitle: "執筆、取材、公開対話。",
  writingCtaBody: "インタビュー、ゲスト講演、文化解説、編集協働、一般向けの学術プロジェクトについてご相談ください。",
  writingCtaLink: "執筆プロジェクトについて話す",
  mapEyebrow: "プロフィールの地図",
  mapTitle: "主な活動分野。",
  mapOneTitle: "アカデミックな拠点",
  mapOneBody: "APU、異文化コミュニケーション、グローバル・ラーニング、EMI、カリキュラム設計、ファカルティ・ディベロップメント。",
  mapTwoTitle: "パブリックな声",
  mapTwoBody: "Mazzi名義でPSX Extremeに執筆する、日本、ゲーム、メディア文化の記事。",
  mapThreeTitle: "研究と教育",
  mapThreeBody: "異文化学習、言語、授業参加、ファカルティ・ディベロップメントに関する研究。",
  mapFourTitle: "講演と協働",
  mapFourBody: "招待講演、ワークショップ、エッセイ、共同プロジェクト。",
  ...
  essayPageTitle: "説明書のない世界を読む",
  essayPageDeck: "ゲーム、日本の日常、公共的な文章、異文化教育についてのエッセイです。",
  navWork: "実践",
  ...
  heroLede: "2009年から日本で暮らし、働いています。立命館アジア太平洋大学では、授業、教職員向けワークショップ、異文化・多言語学習に取り組んでいます。",
  ...
  apuBandTitle: "APUでの異文化教育とファカルティ・ディベロップメント。",
  apuBandBody: "別府を拠点に、APUで異文化教育、ファカルティ・ディベロップメント、パブリック・コミュニケーションに取り組んでいます。",
  heroPrimary: "ワークショップを見る",
  heroSecondary: "事例を見る",
  identityStrip: "教育開発センター・国際プログラム・大学院・多言語で教えるチームのために",
  startHereEyebrow: "ここから始める",
  startHereNavLabel: "ポートフォリオを巡る三つの入口",
  startHereTitle: "探しているものに最も近い仕事から、ご覧ください。",
  startHereDeck: "教育・ファカルティ・ディベロップメント、研究、執筆から選べます。それぞれの入口から関連するプロジェクトと資料へ進みます。",
  startHereTeachingAudience: "教育者・教育機関の方へ",
  startHereTeachingTitle: "教育とファカルティ・ディベロップメント",
  startHereTeachingBody: "多言語・異文化の学びを支える授業、ワークショップ、教材、実践的なツール。",
  startHereTeachingLink: "教育ポートフォリオへ →",
  startHereResearchAudience: "研究者・共同研究者の方へ",
  startHereResearchTitle: "研究",
  startHereResearchBody: "異文化学習、言語テクノロジー、高等教育に関する論文とプロジェクト。",
  startHereResearchLink: "研究を見る →",
  startHereWritingAudience: "読者・メディア・文化プロジェクトの方へ",
  startHereWritingTitle: "日本、ゲーム、パブリック・ライティング",
  startHereWritingBody: "Mazziとして約30年にわたり続けてきた取材、長文記事、文化の読み解き。",
  startHereWritingLink: "執筆を見る →",
  trajectoryEyebrow: "背景",
  trajectoryTitle: "クラクフ、北海道、別府での学びと仕事。",
  trajectoryBodyOne: "クラクフで言語と文学を学んだ後、MEXT奨学生として来日し、北海道大学で情報科学の博士号を取得しました。専門は自然言語処理です。",
  trajectoryBodyTwo: "約30年にわたりMazziとしてポーランドの読者に執筆してきました。大学では、語学学習システム、自然言語処理、異文化クラスルーム、ファカルティ・ディベロップメントに取り組んできました。",
  timelineEyebrow: "いくつかの座標",
  timelineTitle: "研究・教育・執筆の主な歩み。",
  timelineOneTitle: "日本での出発",
  timelineOneBody: "MEXT奨学生として来日し、言語のあいだで生きる日々の仕事を学び始めます。",
  timelineOneLink: "活動記録を見る ↗",
  timelineTwoTitle: "情報科学の博士研究",
  timelineTwoBody: "北海道大学の情報科学博士課程を経て、文脈、選択、学習者経験を中心に据えるCo-MIXの語学学習システム研究へ進みました。",
  timelineTwoLink: "Co-MIXの研究を見る ↗",
  timelineThreeTitle: "ファカルティ・ディベロップメント研修",
  ...
  timelineFiveBody: "APUでは、異文化学習、ファカルティ・ディベロップメント、教育、パブリック・コミュニケーションに取り組んでいます。",
  ...
  proofEyebrow: "実績",
  proofTitle: "教育とファカルティ・ディベロップメントの4つの事例。",
  ...
  bridgeEyebrow: "大学とメディアでの仕事",
  bridgeTitle: "大学での仕事と、約30年にわたるゲームについての執筆。",
  bridgeBodyOne: "Mazziとして、日本からのレポート、ゲーム制作者へのインタビュー、東京ゲームショウの取材、ポーランドの読者向けの長文記事を手がけてきました。",
  bridgeBodyTwo: "大学では、異文化コミュニケーション、グローバル・ラーニング、ファカルティ・ディベロップメント、多言語高等教育に取り組んでいます。",
  writingPageLink: "執筆ポートフォリオを見る",
  bridgeQuote: "高等教育と、日本・ゲーム・メディアについての執筆。どちらも長年続けてきた仕事です。",
  identityAcademicTerm: "学術活動",
  identityAcademicDesc: "助教、高等教育研究者、ファカルティ・ディベロッパー。",
  identityPublicTerm: "執筆",
  identityPublicDesc: "日本を拠点に、ゲーム、メディア、ポップカルチャー、日常の解釈について書くライター。",
  identityAxisTerm: "主なテーマ",
  identityAxisDesc: "国境を越えるコミュニケーション、学び、文化、意味。",
  essayEyebrow: "ポジション・エッセイ",
  essayTitle: "説明書のない世界を読む。",
  essayBody: "ゲーム、日本の日常、公共的な文章、異文化教育についてのエッセイです。",
  essayLink: "エッセイを読む",
  ...
  contactBody: "教育開発センター、国際プログラム、大学院、そして多言語・異文化間学習を育てる教育チームとの協働に特に関心があります。",
  ...
  contactProfilesEyebrow: "関連リンク",
  contactProfilesTitle: "所属、研究、発信を確認できる公式リンク。",
  contactInstagramEyebrow: "From Japan, Mostly",
  contactInstagramTitle: "CVの見出しには入らない、小さな日々の記録。",
  contactInstagramBody: "日本、ゲーム、旅、本、日々の観察についての投稿です。",
  contactInstagram: "@mazzipl を見る",
  contactInstitution: "APU 教員プロフィール",
  contactInstitutionDetail: "所属機関での記録と現在の教員情報。",
  contactResearch: "researchmap",
  contactResearchDetail: "論文、プロジェクト、研究活動。",
  contactProfessional: "LinkedIn",
  contactProfessionalDetail: "職歴と現在のネットワーク。",
  contactPublic: "Torii インタビュー",
  contactPublicDetail: "日本での生活と仕事についてのロングインタビュー。",
  serviceEyebrow: "教育ポートフォリオ",
  serviceTitle: "現実の学びの課題からつくる授業、ワークショップ、セミナー",
  serviceDeck: "正課授業、実践的なワークショップ、大学コミュニティ向けのセミナーを担当しています。異文化コミュニケーション、EMI、授業設計、評価、アクティブ・ラーニング、責任あるAI利用を扱います。",
  ...
  teachingMaterialsTitle: "授業とワークショップで使用した資料の4例。",
  teachingMaterialsDeck: "プレゼンテーション、活動設計、フィードバック、異文化コミュニケーションのセッションで使用したオリジナル資料から選びました。",
  ...
  interactiveLabTitle: "ポートフォリオの三つのインタラクティブ活動を試せます。",
...
const coMixCopy = {
  ...
  pl: {
    ...
    completeTitle: "Właśnie ukończyłeś jedną pętlę uczenia się z Co-MIX.",
    completeBody: "Odczytałeś znaczenie z kontekstu, przypomniałeś sobie słowo{attempts} i rozpoznałeś je w nowej sytuacji. Żadna odpowiedź nie została zapisana.",
...
const teachingDesignStudioCopy = {
  ...
  pl: {
    ...
    copySuccess: "Konspekt aktywności został skopiowany. Dostosuj go do własnego kontekstu.",
    ...
    levers: {
      purpose: { label: "Cel", choices: ["Zauważenie wzorca", "Porównanie dwóch interpretacji", "Podjęcie uzasadnionej decyzji"] },
      task: { label: "Zadanie", choices: ["Oznaczenie krótkiego przykładu", "Uporządkowanie dwóch możliwych odpowiedzi", "Napisanie dwuzdaniowego wyjaśnienia"] },
      ...
      product: { label: "Rezultat", choices: ["Jedna jasno nazwana obserwacja", "Dwuzdaniowa teza", "Jedna poprawiona instrukcja"] },
    },
    challenges: [
      {
        id: "quiet",
        title: "W sali jest cicho",
        deck: "Studenci znają treść, ale niewiele osób włącza się do rozmowy.",
        outputTitle: "Od cichego namysłu do wspólnej obserwacji",
        summary: "Najpierw daj każdej osobie chwilę na samodzielne zastanowienie, a potem stwórz bezpieczne przejście do rozmowy.",
        defaults: [2, 0, 0, 0, 0],
      },
      {
        id: "lecture",
        ...
        outputTitle: "Zatrzymaj wyjaśnienie i pokaż, że idea została zrozumiana",
...
const writingGamebookCopy = {
  ...
  pl: {
    ...
    notebookEmpty: "Notatnik jest jeszcze pusty — co samo w sobie może być pierwszą obserwacją.",
    ...
    humanMoment: {
      ...
      body: "Przez chwilę wydarzenie przestaje być maszyną do wypuszczania produktów, a staje się przestrzenią pełną ludzi. Zapisujesz reakcję — pauzę, uśmiech, osobę tłumaczącą żart przyjacielowi. To materiał, który pozwala pokazać kontekst jako przeżyte doświadczenie, a nie tylko komunikat.",
      choices: [
    ...
    crowdEnd: {
      ...
      lesson: "Ruch redakcyjny: ograniczenie może stać się uczciwą perspektywą, jeśli opisujesz to, co odsłania, a nie tylko to, co uniemożliwia.",
    ...
    trainEnd: {
      ...
      body: "Pociąg zabrał cię za Chibę, a notatnik zsuwa się z kolan. To nie jest efektowne zakończenie, ale właściwe: reportaż w terenie ma ciało, rozkład jazdy i granice. Jutro w notatkach nadal będzie historia. Dzisiaj jest w nich mapa drogi powrotnej.",
...
(() => {
  ...
  const passportCopy = {
    en: {
      ...
      deck: "This is a small stamp-rally game across the site. Open the seven routes below, complete the indicated action in each one, and collect a stamp as you go.",
      rewardHint: "Collect all seven stamps to unlock one final, personal page.",
      ...
      finalTitle: "Passport complete.",
      finalBody: "You collected all seven stamps and opened the final page.",
      ...
      note: "Thank you for exploring the Teaching, Research, Writing, and Public Record sections.",
    ...
    pl: {
      ...
      deck: "To mała gra polegająca na zbieraniu pieczątek na całej stronie. Otwórz siedem tras poniżej, wykonaj zadanie wskazane przy każdej z nich i po drodze zbieraj pieczątki.",
      rewardHint: "Zbierz wszystkie siedem pieczątek, aby odblokować ostatnią, osobistą stronę.",
      ...
      firstToast: "Nowa pieczątka została zdobyta",
      ...
      finalEyebrow: "Ukryta ósma pieczątka",
      finalHanko: "BETWEEN WORLDS",
      finalTitle: "Paszport ukończony.",
      finalBody: "Zebrałeś wszystkie siedem pieczątek i otworzyłeś ostatnią stronę.",
      ...
      note: "Dziękuję za odwiedzenie części poświęconych dydaktyce, badaniom, pisaniu i dorobkowi publicznemu.",
      ...
      story: [
        ...
        "Tak jednak nie było. Hokkaido nauczyło mnie, że każde przybycie mieści w sobie przyszłe pożegnania; przeprowadzka do Beppu kazała rozpocząć jeszcze raz. Człowiek nie odnajduje siebie raz na zawsze. Robi to wielokrotnie — w kolejnym języku, kolejnej sali i następnej wersji domu.",
      ],
      ...
      tracePlaceholder: "Udało mi się odnaleźć nić…",
      ...
      traceLocal: "Twój ślad został zapisany na wspólnej ścianie.",
      traceLocalFallback: "Twój ślad został zapisany prywatnie w tej przeglądarce, dopóki wspólna ściana nie będzie gotowa.",
      ...
      traceCounter: "Liczba pozostawionych śladów: {count}",
    ...
    ja: {
      ...
      restore: "探検パスポートを戻す",
      title: "探検パスポート",
      deck: "これはサイトをめぐる小さなスタンプラリーです。下の7つのルートを開き、それぞれに書かれた操作を行って、スタンプを集めてください。",
      ...
      finalHanko: "BETWEEN WORLDS",
      finalTitle: "パスポート完成。",
      finalBody: "七つのスタンプを集め、最後のページを開きました。",
      ...
      note: "教育、研究、執筆、公開実績の各セクションをご覧いただき、ありがとうございます。",
      storyLabel: "もう一つの物語",
