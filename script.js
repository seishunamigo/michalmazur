...
const translations = {
  en: {
    ...
    contactInstagramBody: "A quieter, more personal thread: Japan, games, travel, books, everyday observations, and the occasional thing that simply made me stop and look.",
  ...
  pl: {
    ...
    trajectoryBodyTwo:
      "Gry otworzyły mi jedną z pierwszych dróg do Japonii. Od blisko trzech dekad piszę jako Mazzi dla polskich czytelników, a praca uniwersytecka prowadziła mnie od systemów wspierających naukę języków do klas międzykulturowych i rozwoju dydaktycznego kadry. Obie ścieżki wyrastają z tego samego odruchu: zrozumieć, jak działa dany świat, i wyjaśnić go bez zacierania tego, co czyni go odmiennym.",
    ...
    writingPageTitle: "Relacje z Japonii, historia gier i subtelne rzeczy, które gry potrafią odsłonić.",
    writingPageDeck:
    ...
    mapThreeBody:
      "Wspólnym tematem jest to, jak ludzie interpretują nieznane światy, uczą się ich kodów i komunikują się w różnych kontekstach.",
    ...
    contactInstagramBody: "Spokojniejsza, bardziej osobista ścieżka: Japonia, gry, podróże, książki, codzienne obserwacje i rzeczy, które po prostu kazały mi się zatrzymać.",
    ...
    serviceDeck:
      "Prowadzę kursy akademickie, praktyczne warsztaty i seminaria dla społeczności uniwersyteckich. W ciągu dekady pracy nad jakością dydaktyki na Hokkaido University i APU stale powraca jeden motyw: zaczynam od problemu, który ludzie naprawdę rozpoznają, i kończę konkretnym krokiem, który mogą wykorzystać w swojej praktyce.",
    ...
    teachingMaterialsTitle: "Cztery przykłady tego, jak zamieniam idee w praktyczne działania dydaktyczne.",
    teachingMaterialsDeck:
      "To wybrane slajdy z oryginalnych prezentacji, które sam zaprojektowałem i przeprowadziłem. Pokazują, jak struktura wizualna, prowadzona refleksja i jasno określone momenty podejmowania decyzji wspierają proces uczenia się.",
...
translations.ja = {
  ...
  contactInstagramBody: "日本での暮らし、ゲーム、旅、本、日々の観察、そしてふと足を止めたくなったものを、もう少し気軽に載せています。",
