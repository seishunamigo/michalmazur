...
const translations = {
  ...
  pl: {
    ...
    contactInstagramEyebrow: "From Japan, Mostly",
    contactInstagramTitle: "Mniejsze rzeczy, które nie potrzebują nagłówka w CV.",
...
(() => {
  ...
  const passportCopy = {
    ...
    pl: {
      ...
      deck: "To mała gra typu stamp rally na całej stronie. Otwórz siedem tras poniżej, wykonaj wskazane przy każdej zadanie i po drodze zbieraj pieczątki.",
